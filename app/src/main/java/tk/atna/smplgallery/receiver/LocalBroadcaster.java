package tk.atna.smplgallery.receiver;
...
public class LocalBroadcaster extends BroadcastReceiver {
    ...
    // possible actions
//	public static final int ACTION_EXCEPTION = 0x00000ba1;
	public static final int ACTION_DATA = 0x00000ba2;

    // transferring data keys
//    public static final String ID = "id";

    // default target group
//	public static final int NO_TARGET = 0;

	public static final String LOCAL_BROADCAST_FILTER = "tk.atna.smplgallery";
